...
class GroupUom(models.Model):
    merchant = models.ForeignKey(Merchant, on_delete=models.CASCADE, null=True, related_name='uom_group_merchant_id')
...
class Uom(models.Model):
    merchant = models.ForeignKey(Merchant, on_delete=models.CASCADE, null=True, related_name='uom_merchant_id')
...
class GroupUomDefinition(models.Model):
    merchant = models.ForeignKey(Merchant, on_delete=models.CASCADE, null=True,
                                 related_name='uom_group_def_merchant_id')
    group = models.ForeignKey(GroupUom, on_delete=models.CASCADE, related_name='group_id_definition')
    ...
    updated_at = models.DateTimeField(auto_now=True)
    created_by = models.ForeignKey(User, on_delete=models.CASCADE, blank=True, null=True,
                                   related_name='group_definition_oum_user_created')
    updated_by = models.ForeignKey(User, on_delete=models.CASCADE, blank=True, null=True,
                                   related_name='group_definition_oum_user_update')
